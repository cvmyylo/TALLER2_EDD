...
A continuación se detalla la arquitectura del sistema. Se destaca la implementación manual de la estructura de datos para cumplir con la restricción de NO uso de contenedores STL.
